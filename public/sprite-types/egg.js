spriteTypes.egg = new SpriteType({
    ...
    patterns: {
        default: {
            behaviours: ["unfails", "idles", "dies-if-falls", "jumps", "moves", "grows", "collects", "dies", "changes-type-when-completed", "is-happy-when-completed"],
        },
        happy: {
            behaviours: ["unfails"]
        },
    ...
    animations: {
        ...
        "jump-up": [
            { frame: "egg", x: 0.01, w: 0.98, h: 1.01 },
        ],
        "jump-down": [
            { frame: "egg", s: 0.25, x: 0.025, y: -0.05, w: 0.95, h: 1.1 },
        ],
        "jump-middle": [
            { frame: "egg", s: 0.25, x: -0.01, w: 1.02, h: 0.98 },
        ],
        happy: [{ frame: "cracked" }],
        dead: [{ frame: "cracked" }]
    },
