spriteTypes["1-eyed-zombie"] = new SpriteType({
    ...
    patterns: {
        default: {
            behaviours: ["idles", "looks-around", "follows-player", "changes-players-type", "is-happy-when-completed", "removed-if-energy-0"],
    ...
    animations: {
        ...
        move: [
            ...
            { frame: "look-2", s: 0.1, w: 1.05, h: 0.95, y: 0.05, x: -0.025, loop: 0 },
        ],
        /*
        "jump-up": [
    ...
    paths: {
        ...
        "o-eye": {
            ...
            lineWidth: 1,
            commands: [
                { c: "ar", x: 0.9, y: 0.35, r: 0.25 },
            ]
        },
        "pupil": {
            fill: "#303030",
            commands: [
                { c: "ar", x: 0.9, y: 0.35, r: 0.05 },
            ]
        },
        teeth: {
            stroke: "#303030",
