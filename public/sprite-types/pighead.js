spriteTypes.pighead = new SpriteType({
    ...
    patterns: {
        default: {
            behaviours: ["unfails", "idles", "jumps", "moves", "looks-at-player", "grows", "collects", "dies", "is-happy-when-completed"],
        },
        happy: {
            animation: "happy",
            behaviours: ["unfails"]
    ...
    paths: {
        body: {
            ...
            stroke: "#303030",
            commands: [
                { c: "rc", l: 0.00, t: 0.00, r: 1.0, b: 1.0 },
            ]
        },
        "eyes-open": {
            stroke: "#303030",
        ...
        "mouth-open": {
            fill: "#303030",
            commands: [
                { c: "rc", l: 0.54, t: 0.47, r: 0.9, b: 0.9 }
            ]
        },
        "ears": {
            fill: "#ffa0a0",
