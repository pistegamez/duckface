spriteTypes.ghost = new SpriteType({
    ...
    patterns: {
        default: {
            behaviours: ["changes-direction-on-collision", "idles", "moves-forward", "floats", "kills-player", "is-happy-when-completed"]
        },
        happy: {
            animation: "happy",
            behaviours: []
    ...
    paths: {
        ...
        "eyes-open": {
            ...
            commands: [
                { c: "el", x: 0.88, y: 0.40, rx: 0.1, ry: 0.2, ra: -0.3 },
                { c: "el", x: 0.39, y: 0.40, rx: 0.15, ry: 0.2, ra: 0.3 },
            ]
        },
        "eyes-closed": {
        ...
        mouth: {
            ...
            commands: [
                ...
                //{ c: "lt", x: 0.90, y: 0.65 },
                //{ c: "mt", x: 0.50, y: 0.58 },
                //{ c: "qc", x: 0.50, y: 0.72, cpx: 0.55, cpy: 0.65 },                    
            ]
        },
        smile: {
            stroke: "rgba(48,48,48,0.65)",
