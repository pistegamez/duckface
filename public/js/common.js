...
class Sprite {
    ...
    resetCollisionData() {
        ...
        this.collisionData = {
            ...
            bottom: false,
            top: false,
            t: this.y + this.height * type.collisionBox.t,
            r: this.x + this.width * type.collisionBox.r,
            b: this.y + this.height * type.collisionBox.b,
            l: this.x + this.width * type.collisionBox.l,
            x: this.x,
            y: this.y,
            width: this.width,
            height: this.height,
